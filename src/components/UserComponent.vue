<template>
  <div>
    <h1 style="textAlign:Left">User List</h1>
    <ejs-grid :dataSource="users" :allowResizing='true' :allowSorting='true' :allowFiltering='true' allowPaging='true' 
      :filterSettings='filterSettings' :editSettings='editSettings' :toolbar='toolbar'
      :sortSettings='initialSort' :pageSettings='pageSettings' @actionComplete="onActionComplete">
      <e-columns>
        <e-column field="user_id" headerText="ID" textAlign='Left' isPrimaryKey='true' :visible='false' width='50px'></e-column>
...
import { GridComponent, ColumnsDirective, ColumnDirective, Filter, Page, Sort, Toolbar, Edit, Resize } from "@syncfusion/ej2-vue-grids";
